...
const _brandGradient = LinearGradient(
  ...
  colors: [_accentSoft, AppTheme.primary, _accentCyan],
  stops: [0.0, 0.62, 1.0],
);
...
class SessionLoadingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SessionLoadingView(title: title, subtitle: subtitle),
    );
  }
}
...
class SessionLoadingView extends StatefulWidget {
  final String title;
  final String subtitle;
  final bool compact;
  ...
  @override
  State<SessionLoadingView> createState() => _SessionLoadingViewState();
}

class _SessionLoadingViewState extends State<SessionLoadingView>
    ...
    return DecoratedBox(
      decoration: const BoxDecoration(
        gradient: RadialGradient(
          ...
          radius: 1.12,
          colors: [Color(0xFF1A222D), AppTheme.background],
          stops: [0.0, 1.0],
        ),
      ),
      child: SafeArea(
