...
class AiAssistantIcon extends StatefulWidget {
  final bool isActive;
  final double size;
  ...
  @override
  State<AiAssistantIcon> createState() => _AiAssistantIconState();
}

class _AiAssistantIconState extends State<AiAssistantIcon>
  ...
  @override
  void didUpdateWidget(covariant AiAssistantIcon oldWidget) {
