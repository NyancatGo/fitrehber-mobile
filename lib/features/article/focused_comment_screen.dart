...
class FocusedCommentScreen extends ConsumerStatefulWidget {
  final int icerikId;
  final int focusCommentId;

  const FocusedCommentScreen({
    super.key,
  ...
  @override
  ConsumerState<FocusedCommentScreen> createState() =>
      _FocusedCommentScreenState();
}

class _FocusedCommentScreenState extends ConsumerState<FocusedCommentScreen> {
  ...
  Future<void> _verileriYukle() async {
    ...
    try {
      final icerik = await _api.getIcerikDetay(widget.icerikId);
      final duzListe = await _api.getYorumlar(
        widget.icerikId,
