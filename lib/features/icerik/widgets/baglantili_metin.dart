...
class BaglantiliMetin extends StatefulWidget {
  final String text;
  final TextStyle baseStyle;
  final Color linkColor;

  const BaglantiliMetin({
    super.key,
    required this.text,
  ...
  @override
  State<BaglantiliMetin> createState() => _BaglantiliMetinDurumu();
}

class _BaglantiliMetinDurumu extends State<BaglantiliMetin> {
