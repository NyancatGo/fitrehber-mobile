...
class _BildirimAyarlariPaneli extends StatefulWidget {
  const _BildirimAyarlariPaneli();

  @override
  State<_BildirimAyarlariPaneli> createState() =>
      _BildirimAyarlariPaneliDurumu();
}

class _BildirimAyarlariPaneliDurumu extends State<_BildirimAyarlariPaneli> {
  bool _workout = true;
...
void _showNotificationSheet(BuildContext context) {
  showModalBottomSheet<void>(
    ...
    builder: (context) => const _BildirimAyarlariPaneli(),
  );
}
