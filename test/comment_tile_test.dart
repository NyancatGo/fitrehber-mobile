import 'package:fitrehber_mobile/features/article/widgets/comment_tile.dart';
...
void main() {
  ...
  testWidgets('cuts off replies at the max inline depth', (tester) async {
  ...
  testWidgets('continue button returns the selected comment', (tester) async {
    YorumModel? selected;
    final parent = yorum(
      id: 7,
      mesaj: 'thread parent',
