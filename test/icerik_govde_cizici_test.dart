import 'package:fitrehber_mobile/features/icerik/widgets/icerik_govde_cizici.dart';
import 'package:flutter/material.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  testWidgets('makale gövde çizicisi siteye benzer içerik blokları oluşturur', (
    tester,
  ) async {
    const html = '''
      ...
      const MaterialApp(
        home: Scaffold(
          body: SingleChildScrollView(
            child: IcerikGovdeCizici(html: html, contentWidth: 360),
          ),
        ),
      ),
    );
